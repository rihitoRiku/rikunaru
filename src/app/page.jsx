...
export default function Home() {
  ...
  return (
    <>
      <>
        <CssBaseline />
        <div className={`${meshBackground.background} h-screen`}>
          <Container maxWidth="lg" className="text-gray-200 font-rethink">
            <Box>
              <main>
                <div className="flex flex-col lg:flex-row gap-4">
                  <div className="flex flex-col w-fit justify-center h-screen gap-12">
                    <div className="sm:w-[30rem] w-full">
                      <h1 className="text-6xl sm:text-7xl font-semibold mb-4">
                        I'm Rihito
                      </h1>
                      <p className="text-base text-gray-300">
                        I am a motivated full-stack web developer with expertise
                        in JavaScript, React, Next.js, Node.js, Express,
                    ...
                    <div className="">
                      ...
                      >
                        ...
                        ></span>
                        <ArrowDownwardIcon className="ms-1 z-10" />
                      </button>
                    </div>
                  ...
                  <div className="w-full relative flex flex-col items-center justify-center h-screen">
                    <div className="relative w-full h-full flex items-center justify-center">
                      ...
                      <div className="grid grid-cols-2 grid-rows-2">
                        {/* Horizontal Middle Line (Only Center) */}
                        <motion.div
                        ...
                        {/* Vertical Middle Line (Only Center) */}
                        <motion.div
                        ...
                        >
                          <div
                            className="absolute w-16 h-16 border-dashed border-t-2 border-l-2 border-transparent border-white rounded-tl-full bottom-0 right-0 opacity-40"
                          ></div>
                        </motion.div>
