...
export default function Home() {
  ...
  return (
    <>
      {/* Background */}
      <div
        className={`${meshBackground.background} absolute left-0 top-0 -z-50 h-screen w-full`}
      />
            ...
            <div className="relative z-0">
              ...
              <div className="relative flex w-full flex-col items-start px-4 pt-16 lg:px-8">
                  ...
                  <div className="w-full md:max-w-[36rem]">
                    ...
                    <div className="w-full text-justify text-secondarytext md:max-w-[36rem] md:text-left">
                      <p>
                        ...
                        and actively collaborating on projects. These
                        experiences have enhanced both my technical expertise
                        and teamwork skills, preparing me to contribute
                      ...
                      <div className="rounded-xl border border-borderColorTransparent p-6">
                        ...
                        <ul className="ms-2 list-inside list-disc space-y-1 text-sm text-secondarytext">
                          <li>
                            ...
                            workshops, and enhancing skills in web development
                            and cloud computing.
                          </li>
                          <li>
                            ...
                            contributing to a collaborative learning
                            environment.
                          </li>
                        </ul>
                      </div>
                ...
                <div className="mt-8 w-full text-secondarytext md:hidden">
                  ...
                  <div className="rounded-xl border border-borderColorTransparent p-6">
                    <h3 className="mb-4 text-xl font-semibold">Organization</h3>
                    <ul className="ms-2 list-inside list-disc space-y-1 text-sm text-secondarytext">
                      <li>
                        {" "}
                        <span className="text-primarytext">
                      ...
                      <li>
                        ...
                        students, providing hands-on guidance, and contributing
                ...
                <div className="text-secondarytext">
                  ...
                  <div className="mt-2">
                    <p>
                      ...
                      recruitment. Built a Project Management & Proposal System
                      to streamline project creation, approvals, and role
                      assignments.{" "}
                    </p>
                  ...
                  <div className="mt-2">
                    ...
                    <ul className="mt-2 list-disc space-y-2 pl-5 text-secondarytext">
                      ...
                      <li>
                        ...
                        websites, UI/UX design, developing backend REST APIs,
                        and deploying applications on the Google Cloud Platform.
                      </li>
                      <li>
